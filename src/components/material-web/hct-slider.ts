...
// Forked from https://github.com/material-components/material-web/blob/593705e49722093b5a3d5439c2c8507116fc636e/catalog/src/components/hct-slider.ts
...
export class HCTSlider extends LitElement {
  ...
  override render() {
    ...
    return html`<section>
      <label for="source" id="label" class="color-on-surface-text">${this.label}</label>
      <input
        id="source"
        type="range"
        title=${this.label}
